...
app.controller('shop_ctrl', function ($scope, shop_facto,$http, $rootScope, me){
	...
	console.log("ShopCtrl initialized");
	console.log("début shopCtrl, scope.user : ", $scope.user);
  ...
  $scope.fondsPossedes = $scope.user.premium_cards;
  ...
  */
  $scope.buy_cards = function(){
      if($scope.user.credits < $scope.caddieFonds.length){
